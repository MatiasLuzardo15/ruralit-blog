...
.rha-sticker.tractor { left: 7%; top: -52px; --tilt: -8deg; }
.rha-sticker.notes { right: 7%; top: -48px; --tilt: 7deg; background: #fff0cf; color: #72490f; animation-delay: -1.2s; }
...
/* ---------- Article embed overrides (chats-del-equipo) ---------- */
/* Sin browser bar ni stickers: el frame se integra limpio en el artículo. */
.rha-outer { left: 0; translate: none; width: 100%; }
.rha-frame { border-radius: 1em; }
@media (max-width: 768px) {
  .rha-frame {
    ...
    background: var(--bg-outer);
    border: 1px solid var(--border-rgba);
    box-shadow: 0 0.35em 1.35em rgba(16,24,40,0.055);
  }
  .rha-sidebar,
  .rha-main,
  .rha-demo-cursor { display: none !important; }
  .rha-team-overlay { display: flex !important; }
  .rha-team-backdrop { display: none; }
  .rha-team-panel { width: 100% !important; border-left: 0; box-shadow: none; border-radius: 1.3em; }
}
`;
...
// --- Componente principal (clon del flujo de chats para el artículo) ----------
const ChatsTeamFlowAnimation = () => {
  ...
  }, [startTeamFlow, schedule, clearTimers]);
...
export default ChatsTeamFlowAnimation;
